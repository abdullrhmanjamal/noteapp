  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <form  >
            <input onChange={formik.handleChange} className='form-control mb-4' type="text" name='title' id='title' placeholder='Title' />
            <input onChange={formik.handleChange} className='form-control' type="text" name='content' id='content' placeholder='Content' />
          </form>
        </Modal.Body>
        <Modal.Footer>
        ...
        <div className="col-10 px-lg-5 px-2 py-5">
          ...
          <div className="row mt-5">
            {userNotes.map((note,index)=>{
              return <Note getUserNotes={getUserNotes} noteDetalis={note} key={index} />
            })}
          </div>
